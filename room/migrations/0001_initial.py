# Generated by Django 3.1.7 on 2021-06-06 17:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('unconfirmed', 'Unconfirmed'), ('unfulfilled', 'Unfulfilled'), ('partially fulfilled', 'Partially fulfilled'), ('partially returned', 'Partially returned'), ('returned', 'Returned'), ('fulfilled', 'Fulfilled'), ('canceled', 'Canceled')], default='unfulfilled', max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wholesale_variant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product.wholesaleproductvariant')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='room.room')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='room.roomuser')),
            ],
        ),
        migrations.CreateModel(
            name='Invoice',
